...
public static class RbacService
{
    ...
    {
        if (string.Equals(u.Email, "maipt@maipt.org", StringComparison.OrdinalIgnoreCase)) return true;
...
""");
    ...
    public static bool IsAdmin(AppUser u)=>new[]{"ADMIN","CIO"}.Contains((u.Role??"").ToUpperInvariant());
