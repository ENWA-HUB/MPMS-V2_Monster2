...
export function SettingsPage(){
 ...
 <div className="settings-tabs">
  ...
  <button className={tab==='members'?'active':''} onClick={()=>setTab('members')}><UsersRound/>Team Members</button><button className={tab==='categories'?'active':''} onClick={()=>setTab('categories')}>Categories</button>
